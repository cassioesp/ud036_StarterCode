...
django_unchained = media.Movie("Django Unchained",
                               ...
                               "utal Mississippi plantation owner.")
...
the_shining = media.Movie("The Shining",
                          ...
                          "her into violence, while his psychic son sees horri"
                          "fic forebodings from the past and of the future.")
...
trainspotting = media.Movie("Trainspotting",
                            ...
                            "allure of the drugs and influence of friends.")
...
into_the_wild = media.Movie("Into the Wild",
                            ...
                            "is possessions, gives his entire $24,000 savings "
                            "account to charity and hitchhikes to Alaska to li"
                            "ve in the wilderness. Along the way, Christopher "
                            "encounters a series of characters that shape his "
                            "life.")

# Adding movies to a list.
movies = [fight_club, django_unchained, the_shining, reservoir_dogs,
          trainspotting, into_the_wild]
