...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <img data-toggle="tooltip" title='{movie_storyline} Duration: {movie_duration}' data-placement="bottom" src="{poster_image_url}" width="220" height="342">
    <h2><b>{movie_title}</b></h2>
    <h3><i>{movie_year}</i></h3>
</div>
'''
